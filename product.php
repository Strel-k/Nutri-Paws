    ...
    ?>
        ...
        <?php if ($is_admin) : ?> <!-- Only admins can delete any comment -->
        ...
        <?php endif; ?>
        <?php if ($comment['customer_id'] == $userID) : ?> <!-- Only the comment owner can edit/delete their comment -->
    ...
    document.getElementById("submit-rating-btn").addEventListener("click", function() {
        console.log("Submit rating button clicked."); // Add this line for debugging
